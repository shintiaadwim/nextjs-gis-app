    ...
    return (
        <div className="min-h-dvh bg-white text-zinc-900">
            ...
            <div className="relative flex min-h-dvh">
                ...
                <div
                    className={clsx(
                        'fixed inset-y-0 left-0 z-50 w-56 max-w-[85vw] transition-transform duration-200 md:static md:z-0 md:w-20 md:max-w-none md:translate-x-0 lg:w-56',
                ...
                <main className="min-w-0 flex-1 bg-white px-4 py-4 sm:px-6 sm:py-6 xl:px-8 xl:py-8">{children}</main>
            </div>
        </div>
    )
}